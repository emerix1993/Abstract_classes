...
class Youtube(SocialChannel):
    ...
    def prepost_message(self, text):
        youtube_list_message = Prepost(text=text)
        self.prepost.append(youtube_list_message)
        print(self.prepost)
        return "Valid add"
...
def main():
    ...
    youtube = Youtube(type_social="social network", followers=500)
    while True:
        ...
        if type_social == "facebook":
            ...
            if action == "create":
                ...
                message = input("Enter you message: ")
                print(youtube.prepost_message(text=message))
            elif action == "del":
                message = input("Enter you message for delete: ")
                print(youtube.delete_prepost_message(message))
                print(youtube.get_prepost())
            elif action == "index del":
                index = int(input("Enter you index for delete: "))
                print(youtube.delete_index_message(index))
                print(youtube.get_prepost())
            elif action == "edit":
                text = input("Enter text: ")
                new_text = input("Enter new text: ")
                print(youtube.edit_prepost(text, new_text))
                print(youtube.get_prepost())
            elif action == "list":
                ...
                text = input("Enter message text: ")
                print(youtube.intermediate_stage(text=text))
            elif action == "followers":
                print(youtube.get_followers())
